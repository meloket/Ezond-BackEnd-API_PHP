...
$data = GetMetricDatas($account, $start_date, $end_date, "account", false, $filter_obj);
$ret = GetMainMetricData($data);

$data = GetMetricDatas($account, $start_date, $end_date, "ad", false, $filter_obj);
$ret->result = GetResultMetricData($data);

$data = GetMetricDatas($account, $start_date, $end_date, "account", true, $filter_obj);
