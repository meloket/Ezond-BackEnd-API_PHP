...
/*
Campaign
Clicks, Impressions, Reach, Amount Spent, Average CPC, 
Page Likes, Post Likes, Website Conversions, 
Cost Per Page Like, Cost Per Post Like, Cost Per Website Conversion,
Unique Link Clicks, Unique CTR, Cost per Unique Link Click
...
$campaignSets = json_decode($account->getCampaigns($fields)->getResponse()->getBody());
print_r($campaignSets->data);
echo "<br><br>";
