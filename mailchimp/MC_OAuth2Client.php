...
class MC_OAuth2Client extends OAuth2Client
{
    ...
    public function __construct($strUID)
    {

        //basically, your redirect_url
        $base = SITE_URL;   //your host
        $path = 'mailchimp/callback.php'; //the path on your host

        $client_id = '155046973936';   //client_id from creating app in MC (see README)
        $client_secret = '49714c502f3d310e36fc5470e619914d866ac1118b290b573b'; //client_secret from creating app in MC  (see README)
        ...
        $config = array('client_id' => $client_id, 'client_secret' => $client_secret,
            ...
            'redirect_uri' => $base . $path . "?userID=" . $strUID,
