...
require_once(__DIR__ . '/analytics_functions_1.php');
...
$arr_alias = array("Goal Completions", "Goal Value", "Conversion Rate", "Abandonment Rate");
...
//$medium = "";
//$impressions = "ga:goalCompletionLocation";
