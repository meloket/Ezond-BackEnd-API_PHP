...
require_once(__DIR__ . '/analytics_functions_400.php');
...
$arr_alias = array("Pageviews", "Unique Pageviews", "Pages/Session", "Avg. Time on Page", "Entrances", "Bounce Rate", "Exit Rate", "Page Value");
...
for ($i = 0; $i < count($result); $i++) {
    if (strlen($result[$i]->dimensions) > 60)
        $result[$i]->$headerFld = substr($result[$i]->dimensions, 0, 60);
    else
