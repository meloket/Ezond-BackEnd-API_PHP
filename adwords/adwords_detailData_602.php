...
$arrHeaderFlds = ['Keyword', 'Ad Group', 'Status', 'Campaign', 'Network'];
...
$arrFlds = ['Criteria', 'AdGroupName', 'AdGroupStatus', 'CampaignName', 'AdNetworkType1', 'Clicks', 'Impressions', 'Cost', 'AverageCpc', 'Ctr', 'Conversions', 'CostPerConversion', 'ConversionRate', 'ViewThroughConversions', 'AveragePosition', 'SearchImpressionShare'];
...
$result = GetReport($session, $start_date, $end_date, ReportDefinitionReportType::KEYWORDS_PERFORMANCE_REPORT, $arrFlds, $filter_obj);
