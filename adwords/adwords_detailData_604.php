...
$arrOriginFld = ['Conversion Name', 'Conversions', 'Conversion Rate', 'Cost Per Conversion', 'View-Through Conv.'];

$arrFlds = ['CampaignName', 'CampaignStatus', 'AdNetworkType1', 'ConversionTypeName', 'Conversions', 'ConversionRate', 'CostPerConversion', 'ViewThroughConversions'];

$arrFlds_date = ['Date', 'ConversionTypeName', 'Conversions', 'ConversionRate', 'CostPerConversion', 'ViewThroughConversions'];
...
if ($arrFilter[1] == "Search Network")
    $filter_obj->networkName = "SEARCH";
else if ($arrFilter[1] == "Display Network")
    $filter_obj->networkName = "DISPLAY";

$result = GetReport($session, $start_date, $end_date, ReportDefinitionReportType::CAMPAIGN_PERFORMANCE_REPORT, $arrFlds);
$ret = GetMetricValues($result, $arrOriginFld, $arrHeaderFlds);
$result = GetReport($session, $start_date, $end_date, ReportDefinitionReportType::ACCOUNT_PERFORMANCE_REPORT, $arrFlds_date);
